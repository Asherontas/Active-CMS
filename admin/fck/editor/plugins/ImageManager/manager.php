...
<form action="images.php" id="uploadForm" method="post" enctype="multipart/form-data">
  <fieldset>
    ...
    <div class="dirs">
      ...
      <iframe src="images.php" style="height:<?php echo $IMConfig['thumbnail_height']+45;?>px" name="imgManager" id="imgManager" class="imageFrame" scrolling="auto" title="Image Selection" frameborder="0"></iframe>
    </div>
  </fieldset>
  <!-- image properties -->
  <table class="inputTable">
    ...
    <tr>
      ...
      <td><table cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td>&nbsp;
              <button type="submit" name="submit" onclick="doUpload();">Upload</button></td>
          </tr>
        </table></td>
      <?php } else { ?>
      <td colspan="2"></td>
      ...
      <td colspan="2"><select size="1" id="f_align"  title="Positioning of this image">
    ...
    <tr>
      ...
      <td><table cellpadding="0" cellspacing="0">
          <tr>
            <td><select name="uploadSize" id="uploadSize">
            ...
            <td style="padding-left: 5px;"> (max width x height dimensions) </td>
          </tr>
        </table></td>
      <td></td>
      <td align="right"><?php }else{ ?>
      <td colspan="4" align="right"><?php } ?>
        <input type="hidden" id="orginal_width" />
        <input type="hidden" id="orginal_height" />
        <input type="checkbox" id="constrain_prop" checked="checked" onclick="javascript:toggleConstrains(this);" /></td>
