<body>
	<table class="top_table" width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td><table class="header_table" width="900" border="0" cellpadding="0" cellspacing="0">
				<tr>
				  <td width="760"><a href="#" onclick="location.reload(true); return false;"><img src="<?php echo BASEURL; ?>/images/logo_admin.png" alt="Active CMS" /></a></td>
				  <td width="30" align="right">
					  <?php
						  ...
						  echo $html->url(FRONT_END_URL, $icon_home_admin);
			  ...
			  <?php
				...
				?>
				  ...
				  <td width="30" align="right">
				   <?php
						  ...
						  echo $html->url('docs', $icon_support_admin, array('target' => '_blank'));
				  ?>
			  </td>
				  <td width="30" align="right">
					   <?php
				...
				?>
				  ...
				  <td width="20" align="right"><a href="?ln=fr">FR</a><br /><a href="?ln=en">EN</a></td>
				</tr>
			  </table>
			</td>
		  </tr>
